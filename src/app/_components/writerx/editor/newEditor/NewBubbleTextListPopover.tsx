...
const options = [
    { name: 'Paragraph', icon: 'paragraph', action: (editor: Editor) => editor.chain().focus().setParagraph().run(), isActive: (editor: Editor) => editor.isActive('paragraph') },
    ...
    { name: 'Todo List', icon: 'todo-list', action: (editor: Editor) => editor.commands.toggleTaskList(), isActive: (editor: Editor) => editor.isActive('taskList') },
];

const NewBubbleTextListPopover = ({ editor }: { editor: Editor }) => {
...
export default NewBubbleTextListPopover;
