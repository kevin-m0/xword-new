...
const FlowContentSelection = () => {
  ...
  const handleOnDrop = useCallback(
    async (acceptedFiles: File[]) => {
      ...
      try {
        ...
        await uploadFile(file as File, currentFile.key);
  ...
  return (
    <div className="mx-auto w-full max-w-4xl space-y-6 rounded-lg p-6 shadow-md">
      {/* URL Input */}
        ...
        <div className="flex flex-col gap-2">
          ...
          >
            {({ getRootProps, getInputProps }) => (
              <div
                className="border-xw-secondary bg-xw-background flex w-full flex-col items-center justify-center rounded-[16px] border-[2px] border-dashed py-10"
                {...getRootProps()}
              >
                <input {...getInputProps()} />
                <div className="my-auto flex w-full flex-col items-center justify-center gap-4 p-5 text-center">
        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="mt-2 flex justify-end gap-2">
            ...
            {!transcript ? (
              ...
              >
                Transcribe
                <MagnetIcon className="ml-2 h-4 w-4" />
              </Button>
            ) : (
              <Button
                type="button"
