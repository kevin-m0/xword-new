...
export const TranscriptionField = ({
  ...
  const handleOnFileChange = useCallback((file: File | null) => {
    if (file) {
    ...
    <div className="space-y-4">
      {!transcribedFields[type] ? (
        <div className="flex flex-col gap-6">
          ...
          <div className='w-full border-t border-xw-border relative'>
            <div className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 p-1 bg-xw-sidebar'>OR</div>
          </div>
          ...
          <div>
            <XWDropBox
              ...
              acceptTypes={inputType.toLocaleLowerCase() === "video" ? { "video/*": [] } : { "audio/*": [] }}
