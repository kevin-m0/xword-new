...
export const ImageSourceNav = ({ activeSource, onSourceChange }: ImageSourceNavProps) => {
  const sources = [
    { id: 'generate', label: 'Generate', icon: <Sparkles className="w-4 h-4" /> },
    { id: 'upload', label: 'Upload', icon: <Upload className="w-4 h-4" /> },
    { id: 'link', label: 'Add file link', icon: <Link className="w-4 h-4" /> },
    // eslint-disable-next-line jsx-a11y/alt-text
    { id: 'stock', label: 'Stock images', icon: <Image className="w-4 h-4" /> },
  ];
