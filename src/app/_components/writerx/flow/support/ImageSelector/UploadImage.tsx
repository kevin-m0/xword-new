...
export const UploadImage = ({ onImageUploaded }: UploadImageProps) => {
  ...
  return (
    <div className=" space-y-8">
      <div
        className={`border border-xw-border bg-xw-background border-dashed rounded-xl p-8 transition-colors ${isDragging ? 'border-blue-500 bg-blue-50' : 'border-gray-200'
          }`}
      ...
      >
        <div className="flex flex-col items-center justify-center gap-4">
          ...
          <h1 className="text-center font-semibold text-3xl tb:text-2xl">Drag & Drop Your Image</h1>
          <p className=" text-xw-muted text-sm tb:text-base">
      ...
      {recentImages.length > 0 && (
        <div className="space-y-4">
          <div className="flex justify-between items-center">
            ...
            <Button variant="link" onClick={() => setRecentImages([])}>Clear All</Button>
          </div>
