      ...
      <div className="flex gap-2 items-center justify-between">
        <div className="flex gap-2 items-center flex-1">
          <div className="relative">
            <Search className="absolute z-[50] top-1/2 left-3 transform -translate-y-1/2 w-4 h-4 text-white" />
            <Input
              type="text"
              value={searchQuery}
            ...
            >
              ...
              {selectedImages.includes(image.url) && (
                <div className="absolute inset-0 bg-black/40 rounded-lg ">
                  <div className="h-6 w-6 bg-xw-primary shadow-md rounded-full flex items-center justify-center m-3">
