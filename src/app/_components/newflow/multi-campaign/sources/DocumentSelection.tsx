// components/FlowContentSelection/components/DocumentSelection.tsx
'use client';

import React from 'react';
import { Card } from '@/components/ui/card';
import { useAtom } from 'jotai';
import { multiFlowPrompt } from '../../../../_atoms/multiFlow';
                ...
                docs?.map((doc) => (
                    ...
                    >
                        <div className="p-4">
                            ...
                            {doc.content ? (
                                <p>{doc.content.slice(0, 50)}{doc.content.length > 50 ? '...' : ''}</p>
                            ) : (
