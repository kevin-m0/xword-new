...
import { columns } from "./MediaProjectVideoColumn";
...
export default function MediaProjectDocsTable() {
  ...
  const {
    ...
    isLoading,
    isError,
  } = trpc.assets.getProjectVideos.useQuery({
  ...
  const table = useReactTable({
    data: filteredAssets as MediaProjectVideoDocs[],
    columns,
  ...
  const handleDeleteSelected = () => {
    if (selectedRowIds && selectedRowIds.length > 0) {
      ...
      deleteVideo.mutate({
        ...
        type: "video", // Ensure the correct type is sent
      });
    }
  };
  ...
  return (
    <div className="w-full">
      ...
      <OnTableSelectActions
        ...
        selectedTypes={{ Video: selectedRowIds.length }} // Assuming all selected items are images
